<template>
    <view class="finance-page-cont">
        <view class="coin_card bg-white shadow">
            <view class="coin_img">
                <image src="https://s2.feixiaoquan.com/logo/1/bitcoin.png?x-oss-process=style/coin_36_webp" mode="" />
            </view>
            <view class="align-center totalAmount">
                <text class="gray">总资产</text>
            </view>
            ...
            <view class="log_list">
                <view class="log_item">
                    <view class="_top _flex">
                        ...
                        <view class="quantity text_overflow"><text class="in">+</text><text class="in">1.00000000</text></view>
                    </view>
                 ...
                 <view class="log_item">
                    <view class="_top _flex">
                        ...
                        <view class="quantity"><text class="red">-</text><text class="red">1.00000000</text></view>
                    </view>
                    <view class="_bom _flex">

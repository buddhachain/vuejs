<template>
	<view class="activity-page-cont">
		<view class="auth_modal radius" v-if="isShowAuthModal">
			<view class="icon" @click="isShowAuthModal = false"><u-icon name="close"></u-icon></view>
		...
		<view class="banner_wrap bg-white radius">
			<swiper class="swiper" style="height: 260upx" :indicator-dots="true" :autoplay="false" :duration="230" :circular="true">
				<swiper-item>
					<view class="banner_item"><image src="../../../static/pages/app/banner.png"></image></view>
				</swiper-item>
				<swiper-item>
					<view class="banner_item"><image src="../../../static/pages/app/banner.png"></image></view>
				</swiper-item>
			...
			<view class="info">
				<view class="_img"><image src="../../../static/pages/app/banner.png" mode="" /></view>
				<view class="_center">
					<view class="_name">佐仓罗布林寺</view>
					<view class="_vis"><text class="gray">已有10056人到访过</text></view>
				</view>
				<view class="_to">
		...
		<!-- 富文本内容 -->
		<view class="html_node_root bg-white radius"><text>HTML文本内容</text></view>
		<!-- 进展动态 -->
		<view class="progress_modal bg-white radius">
			...
			<view class="time_lines">
				<TimeLine :isHigh="true">
					<view class="_content">
						<view class="_text">扎西得嘞，各位汉地居士大家好，佐仓罗布林寺十一月金刚手菩萨荟供法会今天圆满，本期十二月绿度母荟供法会在线登记中，愿你们蒙</view>
						<view class="open_btn align-right"><text class="blue">展开</text></view>
						<view class="photos">
							<view>
								<view class="_item" @click="previewImg(0)"><image src="../../../static/pages/app/banner.png" mode="" /></view>
								<view class="_item"><image src="../../../static/pages/app/banner.png" mode="" /></view>
								<view class="_item"><image src="../../../static/pages/app/banner.png" mode="" /></view>
							</view>
							<view>
								<view class="_item"><image src="../../../static/pages/app/banner.png" mode="" /></view>
				...
				<view class="list-item" :class="{ _open: isOpen }">
					<view class="_top _flex">
						<view class="_wrap _flex">
							<view class="img_box"><image src="../../../static/pages/app/banner.png" mode="" /></view>
							<view class="_u_name">用户1111</view>
						</view>

						<view class="_right">
							<view class="_quantity align-right">108 BUD</view>
							<view class="_time align-right"><text class="gray" v-if="trendsTabIndex === 0">01-11 03:10</text></view>
						</view>
					</view>
					<view class="_body">
						...
						<template v-if="isOpen">
							<view class="hidden_msg _msg">
								<view class="_time"><text class="gray">01-12 03:10</text></view>
		...
		<view class="page_footer_wrap bg-white">
			...
			<view class="_main"><button @click="changePopup(true)">他人拜佛一次，替你灭罪一次</button></view>
		</view>
		<uni-popup ref="popup" type="bottom">
			<view class="popup_body bg-white">
				<view class="_header _flex">
					<view class="title gray">参与流程：选择类型 - 填写信息 - 参与成功</view>
					<u-icon name="close" :size="26" @click="changePopup(false)"></u-icon>
				</view>
				<view class="types">
					<view class="_item" v-for="i in 3" :key="i" @click="curActiveType = i" :class="{ active: curActiveType === i }">
						<view class="_wrap">
							<view class="_info _flex">
								<view class="_img"><image src="../../../static/pages/app/banner.png" mode="" /></view>
								<view class="_name">解脱香+哈达+青稞+朵马</view>
								<view class="_price">508 BUD</view>
							</view>
				...
				<view class="_foot" @click="next()"><button>下一步</button></view>
			</view>
		</uni-popup>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		async getDetails() {
			...
			const decs = await invoke('list_commentlabel', {}, '0');
			const de1 = await invoke('list_aftercomment', {}, '0');
		}
	}
};
</script>
